...
/** No interaction */
class ZeroPotential: public PairPotential {
...
class SquareWellPotential: public PairPotential {
...
class HarmonicWellPotential: public PairPotential {
...
/** Harmonic well potential */
class AngularHarmonicWellPotential: public PairPotential {
...
class PatchyPotential: public PairPotential {
  public:
    PatchyPotential(eneT eps, distT sigl, distT rcut, distT siga1, distT siga2);
    eneT calc_energy(
            distT rdist,
            vecT& p_diff,
            Orientation& ore1,
